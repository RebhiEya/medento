 ...
 */
final class Version20251217095259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD user_id INT NOT NULL, DROP patient, CHANGE status status VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD patient VARCHAR(255) NOT NULL, DROP user_id, CHANGE status status VARCHAR(255) NOT NULL');
    }
}
